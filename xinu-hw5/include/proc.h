...
typedef struct pentry
{
	...
	int core_affinity;          /**< core affinity                           */ //core process is running on
    char name[PNMLEN];          /**< process name                            */
	int regs[PREGS];			/**< stored process registers                */ //16 registers for each of the processes = PREGS
} pcb;
...
extern struct pentry proctab[]; //information that has information on all running processes
